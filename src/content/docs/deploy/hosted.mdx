...
- [Hosted (Railway)](/deploy/railway/) - one-click multi-service template with internal cron services
- [Hosted (Render)](/deploy/render/) - one-click `render.yaml` blueprint with managed Postgres
