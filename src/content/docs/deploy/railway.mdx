...
**Image uploads:** add the `STORAGE_*` vars on the **giftwrapt** service. Recipes for Cloudflare R2, AWS S3, Supabase Storage, MinIO, etc. are in [storage.md](/storage/).
...
- [Hosted (Render)](/render/) - the other managed multi-service blueprint
