...
If you're going to rotate this secret, do it **before** you've configured anything via `/admin/settings`. After that point, every rotation is destructive to your stored secrets unless you follow the [clean rotation](/reference/secrets/#option-a-clean-rotation-recommended) procedure.
</Aside>
