...
Either you **or your partner** can edit a claim's cost and split - it's the same household. Only the original claimer can release the claim. And you can't add the **recipient or their partner** as a co-gifter; GiftWrapt blocks it on the server, so the surprise can't help pay for itself.
