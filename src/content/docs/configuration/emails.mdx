...
Once these are set and the server restarts, the admin **Email** page (`/admin/email`) surfaces the email-family toggles and a "Send test email" button you can use to verify delivery end-to-end.
