...
| Be marked Restricted by you | ✗ (rejected) |
| Be marked None by you | ✓ (allowed, and it does hide your lists) |
...
For gift display and cost-splitting, you and your partner are treated as a **single unit** - rendered together (avatars and names side by side, "Alice & Bob") and counted as one share when a gift's cost is split among co-gifters.

A unit **never pairs you with the gift's recipient**, though. A gift *for* your partner shows you on your own - pairing you with them would give the surprise away. GiftWrapt works out who the recipient is for each view and leaves them out of the unit.
...
- **Partners can't be Restricted.** The system rejects that change, and the Restrict toggle is disabled in the settings UI for partner rows. **None** is not covered by that rule: you can set a partner to None, it saves, and it does hide your lists from them.
